///////////////////////////////////////////////////////////////////////////////////////////
// Check For Rooks Or Queen Script
//
...
integer CheckForRooksOrQueen() {
    // Check the row and column for rooks or queen.
    // Check going up.
    integer RowCheck = gRow + 1;
    integer ColCheck = gCol;
    integer Done = FALSE;
    integer Piece;
    integer Move;
    while (!Done) {
        ...
        // See if this is an enemy rook or queen.
        if (Piece == gEnemyRook || Piece == gEnemyQueen)
            return TRUE;
...
default {
    state_entry() {
        ...
        gTestCheckChannel = CHECK_FOR_ROOKS_OR_QUEEN + gTestID;
    }
