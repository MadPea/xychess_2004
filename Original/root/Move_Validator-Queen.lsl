...
CheckValidMoves() {
    ...
    // Check the diagonals, row and col.
    // Check going up and right.
    integer RowCheck = Row + 1;
    integer ColCheck = Col + 1;
    while (CheckMove(RowCheck, ColCheck)) {
        RowCheck++;
        ColCheck++;
    }
